export default {
  description: {
    short: {
      ...
      es_ES:
        'Plataforma de IA autoalojada diseñada para funcionar completamente sin conexión',
      de_DE:
        'Selbst gehostete KI-Plattform für den vollständigen Offline-Betrieb',
      pl_PL:
        'Samodzielnie hostowana platforma AI zaprojektowana do pracy całkowicie offline',
      fr_FR:
        'Plateforme IA auto-hébergée conçue pour fonctionner entièrement hors ligne',
    },
    long: {
      en_US:
      ...
      de_DE:
        'Open WebUI ist eine erweiterbare, funktionsreiche und benutzerfreundliche selbst gehostete KI-Plattform für den vollständigen Offline-Betrieb. Sie unterstützt verschiedene LLM-Runner wie Ollama und OpenAI-kompatible APIs mit integrierter Inferenz-Engine für RAG und ist damit eine leistungsstarke KI-Bereitstellungslösung.',
      pl_PL:
        'Open WebUI to rozszerzalna, bogata w funkcje i przyjazna dla użytkownika samodzielnie hostowana platforma AI zaprojektowana do pracy całkowicie offline. Obsługuje różne silniki LLM, takie jak Ollama i API kompatybilne z OpenAI, z wbudowanym silnikiem wnioskowania dla RAG, co czyni ją potężnym rozwiązaniem do wdrażania AI.',
      fr_FR:
