...
If web search stopped working because the SearXNG address in Open WebUI's settings was edited by hand, there is now a **Reconnect SearXNG** action that restores it and resumes keeping it up to date. Previously that state could only be undone by reinstalling.
...
Si la búsqueda web dejó de funcionar porque la dirección de SearXNG en los ajustes de Open WebUI se editó a mano, ahora existe una acción **Reconectar SearXNG** que la restaura y vuelve a mantenerla al día. Antes, ese estado solo podía deshacerse reinstalando.
...
Wenn die Websuche nicht mehr funktionierte, weil die SearXNG-Adresse in den Einstellungen von Open WebUI von Hand geändert wurde, gibt es jetzt eine Aktion **SearXNG neu verbinden**, die sie wiederherstellt und künftig wieder pflegt. Bisher ließ sich dieser Zustand nur durch eine Neuinstallation beheben.
...
Jeśli wyszukiwanie w sieci przestało działać, ponieważ adres SearXNG w ustawieniach Open WebUI został zmieniony ręcznie, dostępna jest teraz akcja **Połącz ponownie z SearXNG**, która go przywraca i znów utrzymuje aktualnym. Wcześniej ten stan można było naprawić tylko przez ponowną instalację.
...
Si la recherche web ne fonctionnait plus parce que l'adresse de SearXNG avait été modifiée à la main dans les réglages d'Open WebUI, une action **Reconnecter SearXNG** la rétablit désormais et la tient de nouveau à jour. Auparavant, seule une réinstallation permettait de sortir de cet état.
